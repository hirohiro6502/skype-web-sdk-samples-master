...
var config ={
    ...
    */
    ...
    clientid : 'cf3806b4-f2f5-4a90-9f73-54e75cd7fb30',//client id created in Azure AD
    replyurl : 'http://localhost/ucwa_test',//replyurl you set in Azure AD
    appName : 'UCWAÅQTEST'//Application Name registered in Azure AD
};